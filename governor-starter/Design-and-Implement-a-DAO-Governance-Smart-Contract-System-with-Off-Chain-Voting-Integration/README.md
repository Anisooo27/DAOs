...
//const wallet = ethers.Wallet.createRandom().connect(ethers.provider); ////create a wallet with 0ETH
//wallet.address; (here to chack the wallet addres you can change the name based on what you name it )  
